...
class Iubenda_Legal_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input class="widefat" id="<?php echo sanitize_key( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>"/>
		</p>
		<?php
	}
