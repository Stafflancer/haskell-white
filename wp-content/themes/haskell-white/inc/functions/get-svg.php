...
function get_svg( $args = [] ) {
	...
	?>
		class="svg-icon <?php echo esc_attr( $args['icon'] ); ?>"
	<?php
	...
	?>
		...
		if ( is_customize_preview() ) :
			?>
			<use xlink:href="<?php echo esc_url( get_parent_theme_file_uri( '/assets/images/svg-icons/svg-icons-defs.svg#' . esc_html( $args['icon'] ) ) ); ?>"></use>
		<?php else : ?>
