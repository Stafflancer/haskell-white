 ...
 * @return void
 */
function hwcpa_switch_theme() {
	switch_theme( WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'hwcpa_upgrade_notice' );
}
add_action( 'after_switch_theme', 'hwcpa_switch_theme' );
...
add_action( 'load-customize.php', 'hwcpa_customize' );
...
add_action( 'template_redirect', 'hwcpa_preview' );
