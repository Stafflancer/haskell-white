...
<div <?php echo $module_atts; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<div class="card-content">
		<?php if ( ! empty( $module_args['logo'] ) ) : ?>
			<figure class="overflow-hidden" role="img" aria-hidden="true">
				<?php echo wp_get_attachment_image( $module_args['logo'], 'medium', array( 'class' => esc_attr( $image_class ) ) ); ?>
			</figure>
		<?php endif; ?>
