...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'general-content-' . $block['id'],
	'class'    => [ 'acf-block', 'cta', 'general-content', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
...
if ( $block_content['heading'] || $block_content['paragraph']  || $block_content['buttons'] ) :
	?>
				...
				<div class="<?php echo esc_attr( $column_class ); ?>">
					<div class="row align-items-center justify-content-between">
						<div class="col-12 col-md-12 col-lg-9">
							...
							// Content.
							if ( $block_content['paragraph'] ) :
								print_element(
									'content', [
									'content' => $block_content['paragraph'],
									'class'   => '',
								] );
							endif;
							?>
