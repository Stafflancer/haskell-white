...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'card-wide-simple-' . $block['id'],
	'class'    => [ 'acf-block', 'card-wide-simple', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
...
$column_class    = join( ' ', [
	'row',
	'card-wide-simple-block',
	'align-items-end',
	'justify-content-center',
	$block_settings['settings']['heading_color'],
	$block_settings['settings']['text_color']
] );
if(!empty($block_content['section_header']) || !empty($block_content['buttons']) || !empty($block_content['cards'])) : ?>
			...
			<div class="<?php echo esc_attr( $row_class ); ?>">
				<div class="<?php echo esc_attr( $column_class ); ?>"><?php
					...
					if ( ! empty( $block_content['section_header'] ) ) :
						echo '<div class="col-12 col-md-12 col-lg-8">'; 
					...
					<div class="cards"><?php
						...
						if ( ! empty( $block_content['cards'] ) ) :
							...
							foreach ( $block_content['cards'] as $cards ):
								...
								print_module( 'card-wide-simple', $cards );
								echo '</div>';
