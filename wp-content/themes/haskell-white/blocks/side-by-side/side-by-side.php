...
$block_defaults = [
	...
	'class'    => [ 'acf-block', 'side-by-side', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
...
if ( $block_content['image'] || $block_content['content_group'] ) :
	?>
									...
									<div class="content-info-inner"><?php
										...
										if ( $content ) :
											print_element( 'content', [
												'content' => $content,
												'class'   => [ 'side-text', 'post-excerpt', 'm-0' ],
											] );
										endif; 
