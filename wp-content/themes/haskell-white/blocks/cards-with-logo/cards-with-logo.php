...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'cards-with-logo-' . $block['id'],
	'class'    => [ 'acf-block', 'cards-with-logo', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
...
if(!empty($block_content['section_header']) || !empty($block_content['buttons_group']) || !empty($block_content['cards'])) : ?>
			...
			<div class="<?php echo esc_attr( $row_class ); ?>">
				<div class="<?php echo esc_attr( $column_class ); ?>"><?php
					...
					if ( $block_content['buttons'] ) :
						echo '<div class="col-12 col-md-4 text-end">';
								$buttons_group['class']   = '';
				...
				<div class="cards <?php echo 'card-content-alignment'.$card_content_alignment; ?>"><?php
					...
					if ( ! empty( $block_content['cards'] ) ) :
						...
						foreach ( $block_content['cards'] as $cards ):
							...
							print_module( 'card-with-logo', $cards );
							echo '</div>';
