...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'cta-buttons-' . $block['id'],
	'class'    => [ 'acf-block', 'cta', 'cta-buttons', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
		...
		<div class="<?php echo esc_attr( $container_class ); ?>">
			<div class="<?php echo esc_attr( $row_class ); ?>">
				<div class="<?php echo esc_attr( $column_class ); ?>">
					<div class="cta-button-content-block">
						<?php
							// Section Header.
