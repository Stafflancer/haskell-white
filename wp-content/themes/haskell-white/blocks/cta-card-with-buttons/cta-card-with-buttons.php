...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'cta-card-with-buttons-' . $block['id'],
	'class'    => [ 'acf-block', 'cta', 'cta-card-with-buttons', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
...
if ( $block_content['card_color'] || $block_content['heading'] || $block_content['links'] ) :
	?>
		...
		<div class="<?php echo esc_attr( $container_class ); ?>">
			<div class="<?php echo esc_attr( $row_class ); ?>">
				<div class="<?php echo esc_attr( $column_class ); ?>">
					<div class="row align-items-center justify-content-between <?php echo $card_background_class; ?>">
						<div class="col-12 col-md-12">
							<div class="cta-card-with-buttons-block">
								<?php
							// Tagline.
