...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'offices-' . $block['id'],
	'class'    => [ 'acf-block', 'office', 'offices', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
						...
						<div class="col-12 col-md-12">
							<div class="offices-heading-block">
								<?php
									...
									if($block_content['offices']){ ?>
										<div class="offices-row"><?php
											foreach($block_content['offices'] as $offices){
												$location_map =	$offices['location_map'];
												$title = $offices['title'];
												...
												<div class="offices-repeater-item"><?php
													...
													<div class="headquarters-info"><?php 
														...
														<div class="fixed-contact-block"><?php
														} 
														if(!empty($address)){ ?>
