...
$block_defaults = [
	'id'       => ! empty( $block['anchor'] ) ? $block['anchor'] : 'cards-with-tall-image-' . $block['id'],
	'class'    => [ 'acf-block', 'cards-with-tall-image', 'position-relative', 'overflow-hidden', $background_defaults['class'] ],
	'settings' => [
			...
			<div class="<?php echo esc_attr( $row_class ); ?>">
				<div class="<?php echo esc_attr( $column_class ); ?>"><?php
					...
					<div class="cards"><?php
						...
						if ( ! empty( $block_content['cards'] ) ) :
							...
							foreach ( $block_content['cards'] as $cards ):
								...
								print_module( 'card-with-tall-image', $cards );
								echo '</div>';
					...
					if ( $block_content['buttons_group'] ) :
						echo '<div class="col-12 col-md-12 text-center coverage-btn mt-5">';
								$buttons_group['class']   = '';
